...
import { componentsLabel, partCategories } from "@/data/parts";
  ...
  return (
    <>
      <PageHero
        ...
        title={componentsLabel(block.title)}
        lead={block.summary}
        primaryCta={{
      ...
      <JsonLd
        data={[
          ...
          serviceSchema({
            name: `${componentsLabel(block.title).replace(/ Components$/, "")} Component Sourcing`,
