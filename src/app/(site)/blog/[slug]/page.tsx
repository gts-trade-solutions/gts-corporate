  ...
  return (
    <>
      ...
      <CTASection
        ...
        title="Ready to put this into an enquiry?"
        lead="Send what you have — the gaps are what the first reply is for. Drawings, specifications and parts schedules can be attached directly to the form."
        primaryCta={post.cta}
